...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
          <div class="navbar-nav gap-32 align-items-center fw-medium fs-24">
            <a class="nav-link text-white fw-semibold" aria-current="page" href="./index.php#hero">Home</a>
            <a class="nav-link text-white fw-semibold" href="./index.php#facilities">Facilities</a>
            <a class="nav-link text-white fw-semibold" href="./index.php#rooms">Rooms</a>
            <a class="nav-link text-white fw-semibold" href="./index.php#events">Events</a>
            <a class="nav-link text-white fw-semibold" href="./index.php#contactus">Contact Us</a>
          </div>
        </div>
      </div>
    </nav>
  ...
  <main>
    <!-----=====-----===== SECTION : GALLERY =====-----=====----->
    <section class="section gallery py-96">
      <div class="container">
        <div class="gallery_content--texts text-center mb-48">
          <div class="gallery_content--header mb-24">
            <span class="d-block text-primary font-14 fw-semibold">VIEW GALLERY</span>
            <h2 class="text-beta">Our Gallery</h2>
          </div>
          <div class="gallery_content--para">
        ...
        <div class="col-md-4 footer_content--texts order-1 col-sm-6">
          ...
          <ul class="d-flex flex-column gap-18 p-0">
            ...
            <li class="font-16 ls-none fw-medium text-gray-600">
              <a class="td-none footer_content--texts-link font-16 fw-medium text-gray-600"
                href="./index.php#facilities">Facilities</a>
            </li>
            <li class="ls-none">
              <a class="td-none footer_content--texts-link font-16 fw-medium text-gray-600"
                href="./index.php#rooms">Rooms</a>
            </li>
            <li class="ls-none">
              <a class="td-none footer_content--texts-link font-16 fw-medium text-gray-600"
                href="./index.php#events">Events</a>
            </li>
          </ul>
        </div>
