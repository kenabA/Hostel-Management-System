...
<html lang="en">
  ...
  <body>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0">
          <div class="modal-header border-0 d-flex justify-content-end">
            <button
              type="button"
              class="btn p-0 text-primary font-24"
          ...
          >
            <div class="navbar-nav gap-32 align-items-center fw-medium fs-24">
              <a
                ...
                >Home</a
              >
              <a class="nav-link text-white fw-semibold" href="#facilities"
                >Facilities</a
              >
              ...
              <a class="nav-link text-white fw-semibold" href="#events"
                >Events</a
              >
              <a class="nav-link text-white fw-semibold" href="#contactus"
                >Contact Us</a
              >
              <a
                type="button"
    ...
    <main>
            ...
            <div class="col-sm-12 col-md-6">
              <div class="hero_content--texts mb-48">
                <h1 class="text-alpha fw-semibold mb-24 text-black">
                  <span class="text-primary">H</span>amro<span
                    class="text-secondary"
                    >,</span
                  >
                  <span class="text-primary">R</span>amro<span
                    class="text-secondary"
                    >,</span
                  >
                  <span class="text-primary">H</span>ostel<span
                    class="text-secondary"
                    >.</span
                  >
                </h1>
              ...
              <div class="hero_content--btn d-flex gap-32 pe-12">
                <button
                  id="reserve-appointment"
                  class="btn-1 reserve-appointment-btn"
                >
                  Reserve Appointment<i
                    class="ms-12 fa-solid fa-calendar-check"
                  ></i>
                </button>
      ...
      <section
        id="facilities"
        class="section facilities section-facilities py-96"
      >
        <div class="container">
          <div class="row align-items-center g-48">
            <div class="col-md-12 col-lg-6">
              <div class="facilities_content--header mb-32">
                <span class="text-primary d-block font-14 fw-semibold mb-8"
                  >VIEW FACILITIES</span
                >
            ...
            <div class="col-md-12 col-lg-6">
              <div class="row gy-24">
                <div class="col-12 col-lg-6 col-md-6 facilities_content--box">
                  <div
                    class="p-32 rounded-4 facilities_content--details bg-white"
                  >
                    <div
                      class="icon-bx bg-secondary-tint d-inline-block mb-20 p-8 rounded-4"
                    >
                ...
                <div class="col-12 col-lg-6 col-md-6 facilities_content--box">
                  ...
                  >
                    ...
                    >
                      <i
                        class="text-secondary fa-solid fa-shield-halved font-24"
                      ></i>
                    </div>
                    <h3 class="fw-semibold text-secondary mb-24 text-gamma">
                      Safety & Security
                ...
                <div class="col-12 col-lg-6 col-md-6 facilities_content--box">
                  ...
                  >
                    ...
                    >
                      <i
                        class="text-secondary fa-solid fa-face-smile font-24"
                      ></i>
                    </div>
                    <h3 class="fw-semibold text-secondary mb-24 text-gamma">
                      Events & Activities
          ...
          <div class="row align-items-center gy-48">
            <div class="col-md-12 col-lg-6">
              <div class="rooms_content--header mb-32">
                <span class="text-primary font-14 d-block fw-semibold"
                  >VIEW ROOMS</span
                >
                  ...
                  <div class="rounded-4 rooms_content--details">
                    ...
                    <div class="rooms_content--texts p-24">
                      <div class="rooms_content--header mb-24">
                        <span
                          class="mb-8 rounded-5 d-inline-block font-12 bg-primary-tint--1 rounded-5 text-primary-hover py-4 px-8 fw-medium"
                      ...
                      <div class="rooms_content--features">
                        <div
                          class="rooms_content--features-details d-flex align-items-center gap-18 mb-12"
                        >
                          <div class="rooms_content--features-icon">
                            <ion-icon
                              class="text-secondary font-24"
                              name="bed"
                            ></ion-icon>
                          </div>
                        ...
                        <div
                          class="rooms_content--features-details d-flex align-items-center gap-18"
                        >
                          <div class="rooms_content--features-icon">
                            <ion-icon
                              class="text-secondary font-24"
          ...
          <div class="row align-items-center gy-48">
            <div class="col-md-12 col-lg-6">
              <div class="events_content--header mb-32">
                <span class="d-block text-primary font-14 fw-semibold"
                  >VIEW EVENTS</span
                >
              ...
              <div class="row g-24">
                <div class="col-12 col-lg-6 col-md-6 events_content--box">
                  <div class="events_content--imgBx rounded-4">
                    <img
                      src="./image/HappyHoli.jpg"
                      alt=""
                      class="events_content--img"
                    />
                ...
                <div class="col-12 col-lg-6 col-md-6 events_content--box">
                  <div class="events_content--imgBx rounded-4">
                    <img
                      src="./image/krishnajanmasthami.jpg"
                      alt=""
                      class="events_content--img"
                    />
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="swiper-container p-48">
                      <p
                        class="text-gray-600 mb-48 font-16 testimonials_content--testimonial-para"
                      >
                      ...
                      <div class="testimonials_content--personal-details">
                        <div class="testimonials_content--imgBox mb-12">
                          <img
                            class="testimonials_content--img"
                            src="./image/wm1.jpg"
                            alt=""
                          />
                        </div>
                        <span class="d-block font-18 fw-semibold text-black"
                          >Haley Bennet</span
                        >
                        <span class="d-block text-secondary font-14 fw-semibold"
                          >Student</span
                        >
                      </div>
                    </div>
      ...
      <section id="message" class="section message py-96">
        <div class="container">
          <div class="row align-items-center gy-48 gx-32">
            ...
            <div
              class="col-md-12 col-lg-6 col-sm-12 message_content--box col-sm-12"
            >
              <div class="bg-white message_content--formBox p-32 rounded-4">
                <form
                  class="d-flex message_content--form flex-column gap-32"
                  action="https://formspree.io/f/xqkrgkej"
                  method="POST"
                >
                  ...
                  <button
                    type="submit"
                    href="#"
                    class="btn-4-link send-msg d-block w-100"
                  >
                    Send Message
                  </button>
                </form>
        ...
        <div class="row gy-48 gx-32">
          <div class="col-md-4 footer_content--texts order-0 col-sm-12">
            <div class="footer_content--texts-header mb-32">
              <a
                class="font-24 text-primary navbar-brand fw-semibold mb-18"
                href="#header"
            ...
            <div class="footer_content--texts-mediasBox mb-48">
              ...
              <div class="footer_content--texts-medias d-flex gap-18">
                <a class="text-primary-shade--1" href="#"
                  ><i class="font-24 fa-brands fa-facebook"></i
                ></a>
                <a class="text-primary-shade--1" href="#"
                  ><i class="font-24 fa-brands fa-instagram"></i
                ></a>
                <a class="text-primary-shade--1" href="#"
                  ><i class="font-24 fa-brands fa-twitter"></i
                ></a>
              </div>
            </div>
          ...
          <div class="col-md-4 footer_content--texts order-1 col-sm-6">
            ...
            <ul class="d-flex flex-column gap-18 p-0">
              <li class="ls-none">
                <a
                  class="td-none footer_content--texts-link font-16 fw-medium text-gray-600"
                  href="#hero"
                  >Home</a
                >
              </li>
          ...
          <div class="col-md-4 footer_content--texts order-2 col-sm-6">
            ...
            <ul class="d-flex flex-column gap-18 p-0">
              <li class="ls-none">
                <a
                  class="td-none footer_content--texts-link footer-num font-16 fw-medium text-gray-600"
                  href="tel:9842742225"
                  ><i class="fa-solid fa-phone me-12"></i>+977 9842742225</a
                >
              </li>
              <li class="font-16 ls-none fw-medium text-gray-600">
                <a
                  class="td-none footer_content--texts-link footer-mail font-16 fw-medium text-gray-600"
                  href="mailto:kebab.bahadur@gmail.com"
                  ><i class="fa-solid fa-envelope me-12"></i
                  >info@hamrostel.com.np
                </a>
              </li>
              <li class="font-16 ls-none fw-medium text-gray-600">
                <a
                  target="_blank"
                  class="td-none footer_content--texts-link font-16 fw-medium text-gray-600"
                  href="https://www.google.com/maps/place/Herald+College+Kathmandu/@27.712094,85.3281912,17z/data=!3m1!4b1!4m6!3m5!1s0x39eb196de5da5741:0x652792640c70ede9!8m2!3d27.712094!4d85.3307661!16s%2Fg%2F1pyqqt1lz?entry=ttu"
                  ><i class="fa-solid fa-location-dot me-12"></i>Naxal,
                  Kathmandu, Nepal
                </a>
              </li>
            </ul>
